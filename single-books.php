    ...
    <section class="s-content s-content--narrow s-content--no-padding-bottom">
        ...
        <article class="row format-standard">
            ...
            <div class="col-full s-content__main">
                ...
                // here we will show the chapters
                $parent_chargs = array(
                    'post_type' => 'chapter',
                    'posts_per_page' => -1,
                ...
                $parent_chapters = new WP_Query($parent_chargs);

                echo "<h3>";
                _e("Chapters","iphiloso");
                echo "</h3>";
                while($parent_chapters->have_posts()){
                    $parent_chapters->the_post();
                ...
                <p class="s-content__tags">
                    <span><?php  _e("Languages","iphiloso") ?></span>

                    <span class="s-content__tag-list">
                       <?php 
                       the_terms(get_the_ID(), 'languages', '', ', ', '');
                       ?>
                    </span>
